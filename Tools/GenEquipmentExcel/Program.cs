...
// 爪专属词缀数据来源：https://poedb.tw/cn/Claws#ModifiersCalc
{
    SetupSheet("词缀定义", "equipment.txt", "EquipmentModConf.pb", "EquipmentModConf",
        new[] { "EquipmentModId", "EquipmentModName", "EquipmentModType",
                ...
                "EquipmentModDisplayTab", "EquipmentModStatType", "EquipmentModModifierType" });
    var ws = pkg.Workbook.Worksheets["词缀定义"]!;
    // 列说明: Id, 词缀名, 类型(1前缀/2后缀), 等阶, 需求等级, 适用小类别Id列表(|分隔), 权重(越高越容易出现),
    //         DisplayTab(1伤害/2防御/3其他,决定在角色面板哪个页签显示),
    //         StatType(对应 StatType 枚举名,留空则不写入 StatsComponent),
    //         ModifierType(Flat/PercentAdd/PercentMore,默认 Flat)
    // ===== 前缀 =====
    // 物理伤害前缀（爪专属）
    // 攻击速度前缀（爪专属）
    // 暴击率前缀（爪/匕首共用）
    ...
    WriteRows(ws, new object[][]
    {
        ...
        new object[] {  1, "残忍",         1, 1, 60, "1",  100, "1", "PhysicalDamage", "Flat" }, // 增加 (35-45) 到 (70-80) 物理伤害
        new object[] {  2, "凶猛",         1, 2, 46, "1",  200, "1", "PhysicalDamage", "Flat" }, // 增加 (25-32) 到 (50-62) 物理伤害
        new object[] {  3, "锋利",         1, 3, 35, "1",  400, "1", "PhysicalDamage", "Flat" }, // 增加 (18-22) 到 (36-44) 物理伤害
        new object[] {  4, "尖锐",         1, 4, 23, "1",  700, "1", "PhysicalDamage", "Flat" }, // 增加 (12-15) 到 (24-30) 物理伤害
        new object[] {  5, "锐利",         1, 5, 11, "1", 1000, "1", "PhysicalDamage", "Flat" }, // 增加 (7-9) 到 (14-18) 物理伤害
        new object[] {  6, "磨砺",         1, 6,  1, "1", 1500, "1", "PhysicalDamage", "Flat" }, // 增加 (2-4) 到 (5-8) 物理伤害
        // 攻击速度 - 爪专属前缀（5阶）
        new object[] {  7, "迅捷",         1, 1, 60, "1",  100, "1", "AttackSpeed", "PercentAdd" }, // 攻击速度提高 (20-24)%
        new object[] {  8, "快速",         1, 2, 46, "1",  200, "1", "AttackSpeed", "PercentAdd" }, // 攻击速度提高 (15-19)%
        new object[] {  9, "敏捷",         1, 3, 30, "1",  400, "1", "AttackSpeed", "PercentAdd" }, // 攻击速度提高 (11-14)%
        new object[] { 10, "灵活",         1, 4, 15, "1",  700, "1", "AttackSpeed", "PercentAdd" }, // 攻击速度提高 (7-10)%
        new object[] { 11, "轻盈",         1, 5,  1, "1", 1000, "1", "AttackSpeed", "PercentAdd" }, // 攻击速度提高 (3-6)%
        // 暴击率 - 爪/匕首共用前缀（5阶）
        new object[] { 12, "精准",         1, 1, 60, "1|2",  100, "1", "CriticalChance", "PercentAdd" }, // 暴击率提高 (35-40)%
        new object[] { 13, "犀利",         1, 2, 44, "1|2",  200, "1", "CriticalChance", "PercentAdd" }, // 暴击率提高 (25-29)%
        new object[] { 14, "致命",         1, 3, 30, "1|2",  400, "1", "CriticalChance", "PercentAdd" }, // 暴击率提高 (18-22)%
        new object[] { 15, "锐利",         1, 4, 15, "1|2",  700, "1", "CriticalChance", "PercentAdd" }, // 暴击率提高 (10-14)%
        new object[] { 16, "尖刺",         1, 5,  1, "1|2", 1000, "1", "CriticalChance", "PercentAdd" }, // 暴击率提高 (5-9)%
        // 生命偷取 - 爪专属前缀（4阶）
        new object[] { 17, "吸血",         1, 1, 50, "1",  100, "2", "LifeLeech", "Flat" }, // 造成物理伤害时偷取 (2.0-2.4)% 生命
        new object[] { 18, "汲取",         1, 2, 35, "1",  250, "2", "LifeLeech", "Flat" }, // 造成物理伤害时偷取 (1.5-1.9)% 生命
        new object[] { 19, "汲血",         1, 3, 20, "1",  500, "2", "LifeLeech", "Flat" }, // 造成物理伤害时偷取 (1.0-1.4)% 生命
        new object[] { 20, "渗血",         1, 4,  1, "1", 1000, "2", "LifeLeech", "Flat" }, // 造成物理伤害时偷取 (0.4-0.9)% 生命
        // 魔力偷取 - 爪专属前缀（4阶）
        new object[] { 21, "汲魔",         1, 1, 50, "1",  100, "3", "ManaLeech", "Flat" }, // 造成物理伤害时偷取 (2.0-2.4)% 魔力
        new object[] { 22, "汲取魔力",     1, 2, 35, "1",  250, "3", "ManaLeech", "Flat" }, // 造成物理伤害时偷取 (1.5-1.9)% 魔力
        new object[] { 23, "魔力汲取",     1, 3, 20, "1",  500, "3", "ManaLeech", "Flat" }, // 造成物理伤害时偷取 (1.0-1.4)% 魔力
        new object[] { 24, "魔力渗取",     1, 4,  1, "1", 1000, "3", "ManaLeech", "Flat" }, // 造成物理伤害时偷取 (0.4-0.9)% 魔力
        // 暴击伤害 - 爪/匕首共用前缀（5阶）
        new object[] { 25, "毁灭",         1, 1, 60, "1|2",  100, "1", "CriticalMultiplier", "PercentAdd" }, // 暴击伤害加成 (50-59)%
        new object[] { 26, "破坏",         1, 2, 44, "1|2",  200, "1", "CriticalMultiplier", "PercentAdd" }, // 暴击伤害加成 (35-44)%
        new object[] { 27, "重击",         1, 3, 30, "1|2",  400, "1", "CriticalMultiplier", "PercentAdd" }, // 暴击伤害加成 (25-29)%
        new object[] { 28, "强力",         1, 4, 15, "1|2",  700, "1", "CriticalMultiplier", "PercentAdd" }, // 暴击伤害加成 (15-19)%
        new object[] { 29, "有力",         1, 5,  1, "1|2", 1000, "1", "CriticalMultiplier", "PercentAdd" }, // 暴击伤害加成 (5-9)%

        // ===== 后缀（EquipmentModType=2）=====
        // 攻击速度 - 爪后缀（4阶）
        new object[] { 30, "的迅速",       2, 1, 55, "1",  100, "1", "AttackSpeed", "PercentAdd" }, // 攻击速度提高 (13-15)%
        new object[] { 31, "的速度",       2, 2, 38, "1",  250, "1", "AttackSpeed", "PercentAdd" }, // 攻击速度提高 (9-12)%
        new object[] { 32, "的敏捷",       2, 3, 20, "1",  500, "1", "AttackSpeed", "PercentAdd" }, // 攻击速度提高 (5-8)%
        new object[] { 33, "的轻盈",       2, 4,  1, "1", 1000, "1", "AttackSpeed", "PercentAdd" }, // 攻击速度提高 (2-4)%
        // 暴击率 - 爪后缀（4阶）
        new object[] { 34, "的精准",       2, 1, 55, "1",  100, "1", "CriticalChance", "PercentAdd" }, // 暴击率提高 (25-30)%
        new object[] { 35, "的犀利",       2, 2, 38, "1",  250, "1", "CriticalChance", "PercentAdd" }, // 暴击率提高 (15-19)%
        new object[] { 36, "的致命",       2, 3, 20, "1",  500, "1", "CriticalChance", "PercentAdd" }, // 暴击率提高 (8-12)%
        new object[] { 37, "的锐利",       2, 4,  1, "1", 1000, "1", "CriticalChance", "PercentAdd" }, // 暴击率提高 (3-7)%
        // 命中 - 爪后缀（4阶）（项目当前未实现 Accuracy StatType，仅按 DisplayTab=3 展示到“其他”页签）
        new object[] { 38, "的命中",       2, 1, 55, "1",  100, "3", "", "Flat" }, // 命中值 +(300-350)
        new object[] { 39, "的准确",       2, 2, 38, "1",  250, "3", "", "Flat" }, // 命中值 +(175-225)
        new object[] { 40, "的瞄准",       2, 3, 20, "1",  500, "3", "", "Flat" }, // 命中值 +(100-150)
        new object[] { 41, "的精确",       2, 4,  1, "1", 1000, "3", "", "Flat" }, // 命中值 +(30-60)
        // 力量 - 通用后缀（4阶）
        new object[] { 42, "的力量",       2, 1, 55, "1",  100, "3", "Strength", "Flat" }, // 力量 +(23-27)
        new object[] { 43, "的强壮",       2, 2, 38, "1",  250, "3", "Strength", "Flat" }, // 力量 +(16-22)
        new object[] { 44, "的体魄",       2, 3, 20, "1",  500, "3", "Strength", "Flat" }, // 力量 +(9-15)
        new object[] { 45, "的肌肉",       2, 4,  1, "1", 1000, "3", "Strength", "Flat" }, // 力量 +(3-8)
        // 敏捷 - 通用后缀（4阶）
        new object[] { 46, "的敏捷度",     2, 1, 55, "1",  100, "3", "Dexterity", "Flat" }, // 敏捷 +(23-27)
        new object[] { 47, "的灵巧",       2, 2, 38, "1",  250, "3", "Dexterity", "Flat" }, // 敏捷 +(16-22)
        new object[] { 48, "的身法",       2, 3, 20, "1",  500, "3", "Dexterity", "Flat" }, // 敏捷 +(9-15)
        new object[] { 49, "的轻功",       2, 4,  1, "1", 1000, "3", "Dexterity", "Flat" }, // 敏捷 +(3-8)
        // 智慧 - 通用后缀（4阶）
        new object[] { 50, "的智慧",       2, 1, 55, "1",  100, "3", "Intelligence", "Flat" }, // 智慧 +(23-27)
        new object[] { 51, "的睿智",       2, 2, 38, "1",  250, "3", "Intelligence", "Flat" }, // 智慧 +(16-22)
        new object[] { 52, "的学识",       2, 3, 20, "1",  500, "3", "Intelligence", "Flat" }, // 智慧 +(9-15)
        new object[] { 53, "的聪慧",       2, 4,  1, "1", 1000, "3", "Intelligence", "Flat" }, // 智慧 +(3-8)
        // 火焰抗性 - 通用后缀（4阶）
        new object[] { 54, "的火焰",       2, 1, 55, "1",  100, "2", "FireResistance", "Flat" }, // 火焰抗性 +(24-28)%
        new object[] { 55, "的炎热",       2, 2, 38, "1",  250, "2", "FireResistance", "Flat" }, // 火焰抗性 +(16-23)%
        new object[] { 56, "的温暖",       2, 3, 20, "1",  500, "2", "FireResistance", "Flat" }, // 火焰抗性 +(9-15)%
        new object[] { 57, "的灼热",       2, 4,  1, "1", 1000, "2", "FireResistance", "Flat" }, // 火焰抗性 +(3-8)%
        // 冰霜抗性 - 通用后缀（4阶）
        new object[] { 58, "的冰霜",       2, 1, 55, "1",  100, "2", "ColdResistance", "Flat" }, // 冰霜抗性 +(24-28)%
        new object[] { 59, "的寒冷",       2, 2, 38, "1",  250, "2", "ColdResistance", "Flat" }, // 冰霜抗性 +(16-23)%
        new object[] { 60, "的冰冻",       2, 3, 20, "1",  500, "2", "ColdResistance", "Flat" }, // 冰霜抗性 +(9-15)%
        new object[] { 61, "的寒意",       2, 4,  1, "1", 1000, "2", "ColdResistance", "Flat" }, // 冰霜抗性 +(3-8)%
        // 闪电抗性 - 通用后缀（4阶）
        new object[] { 62, "的闪电",       2, 1, 55, "1",  100, "2", "LightningResistance", "Flat" }, // 闪电抗性 +(24-28)%
        new object[] { 63, "的雷霆",       2, 2, 38, "1",  250, "2", "LightningResistance", "Flat" }, // 闪电抗性 +(16-23)%
        new object[] { 64, "的电流",       2, 3, 20, "1",  500, "2", "LightningResistance", "Flat" }, // 闪电抗性 +(9-15)%
        new object[] { 65, "的静电",       2, 4,  1, "1", 1000, "2", "LightningResistance", "Flat" }, // 闪电抗性 +(3-8)%
        // 生命 - 通用后缀（5阶）
        new object[] { 66, "的活力",       2, 1, 60, "1",  100, "2", "MaxHealth", "Flat" }, // 最大生命 +(60-79)
        new object[] { 67, "的生命",       2, 2, 46, "1",  200, "2", "MaxHealth", "Flat" }, // 最大生命 +(45-59)
        new object[] { 68, "的健康",       2, 3, 30, "1",  400, "2", "MaxHealth", "Flat" }, // 最大生命 +(30-44)
        new object[] { 69, "的体力",       2, 4, 15, "1",  700, "2", "MaxHealth", "Flat" }, // 最大生命 +(15-29)
        new object[] { 70, "的耐力",       2, 5,  1, "1", 1000, "2", "MaxHealth", "Flat" }, // 最大生命 +(3-14)
    });
}
